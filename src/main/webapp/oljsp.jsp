...
<table>
    <tr>
        ...
        <td><jsp:getProperty name="status1" property="status1"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Last modified </td>
        <td><jsp:getProperty name="status1" property="modified1"/></td>
    </tr>
</table>
<FORM ACTION="ol2jsp.jsp" METHOD="post" >
...
<FORM NAME="form1" ACTION="basic.jsp" METHOD="POST">
    ...
    <INPUT TYPE="BUTTON" VALUE="Add Submission" ONCLICK="button1()">
</FORM>

<SCRIPT LANGUAGE="JavaScript">
    var badgeNumber = localStorage.getItem("badgeNumber");
    document.getElementById("badge").innerHTML = badgeNumber;
    function button1() {
    ...
    function passValue(){
        var checkSubmitted = 1;
        localStorage.setItem("checkSubmit",checkSubmitted);
        localStorage.setItem("badgeNumber",badgeNumber-1);
    }
